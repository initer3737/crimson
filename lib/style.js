...
// ?our fiture start
    /**
     ...
     dinamycClass({class_name}) {
        const classes = class_name?.className
        ...
        const styleTag =Utils.$("#"+this.#style_tag).textContent
        // .mt-4{
        //     margin-top:4px;
        // }
        // .mt-37{
        ...
        const lastDinclassdata = lastDinclassdatas.at(-1)
